...
const _878260 = () => import('../handlers/renderer.mjs');

const handlers = [
  { route: '', handler: _33be66, lazy: true, method: undefined },
  { route: '/__nuxt_error', handler: _878260, lazy: true, method: undefined },
  { route: '/**', handler: _878260, lazy: true, method: undefined }
];
